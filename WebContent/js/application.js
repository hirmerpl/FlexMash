            ...
            listeners: {
                select: function(combo, records, eOpts) {
                    if (records.get('key') == 'source') {
                        ...
                        app.iconURLField.setVisible(false);
                        app.srvTTL.setVisible(true);
                        app.srvPort.setVisible(true);
                        app.srvAddr.setVisible(true);
                        app.srvHealthcheck.setVisible(true);
                        app.srvParams.setVisible(true);
                        app.srvDesc.setVisible(true);
                        app.srvTags.setVisible(true);
                    } else {
                        app.sourceURLField.setDisabled(true);
                        app.sourceURLField.setVisible(false);
                        app.iconURLField.setVisible(true);
                        app.sourceURLField.setVisible(false);
                        app.srvTTL.setVisible(false);
                        app.srvPort.setVisible(false);
                        app.srvAddr.setVisible(false);
                        app.srvHealthcheck.setVisible(false);
                        app.srvParams.setVisible(false);
                        app.srvDesc.setVisible(false);
                        app.srvTags.setVisible(false);
                    }
                }
            }
        });
            ...
            buttons: [{
                ...
                handler: function() {
                    ...
                    if (((diagramNodes.length > 0 && values['nodeType'] == 'subflow') || values['nodeType'] == 'source') && app.addCustomNodeForm.isValid()) {
                        ...
                        // app.addDynamicField(Y, app.srvTTL);
                    } else {
